    ...
    return (
        <section className="container py-5" style={{ lineHeight: "2rem" }}>
                    ...
                    <ul className="list-unstyled mt-3 mb-0 text-primary" style={{ lineHeight: "2.4rem" }}>
                        ...
                        <li><a href="#top-colleges" className="text-decoration-none">Top Nursing Colleges in Dehradun (2025)</a>
                            ...
                            <ul className="ps-3" style={{ listStyleType: "disc", marginLeft: "1.8rem" }}>
                                ...
                                <li><a href="#himalayan" className="text-decoration-none">Himalayan College of Nursing, Jolly Grant</a></li>
                                <li><a href="#dims" className="text-decoration-none">Doon Institute of Medical Sciences (DIMS)</a></li>
                            </ul>

                        </li>
                        <li><a href="#career" className="text-decoration-none">Career Opportunities After Nursing</a></li>
            ...
            <div className="" style={{ marginTop: '3rem !important' }}>
                ...
                <p>
                    Nursing is one of the most respected and essential healthcare professions worldwide. With India's
                    growing population and expanding healthcare system, qualified nurses are in high demand across
                    hospitals, clinics, and community health centers. The profession offers not only job stability but also
                    the opportunity to make a direct impact on people’s lives.
                </p>
                <ol className="mb-5" style={{ listStyleType: "disc", }}>
                    <h3 id="top-colleges">Benefits of Choosing Nursing:  </h3>
                    <li>Excellent job placement opportunities in India and abroad </li>
                    <li>Competitive salaries and government job prospects</li>
                    <li>Career progression into specialties or advanced practice nursing
                    </li>
                    <li>Opportunities in administration, teaching, or hospital management </li>
                    ...
                    <li>
                        ...
                        <ul className="mt-3" style={{ listStyleType: "upper-roman", }}>
                            <li className="mt-3">
                                ...
                                • Auxiliary Nursing and Midwifery (ANM) – 2 Years  <br />
                                • General Nursing and Midwifery (GNM) – 3 Years  <br />
                            ...
                            <li className="mt-3">
                                ...
                                • GNM: 10+2 in any stream with at least 40% marks<br />
                                • B.Sc Nursing: 10+2 with Physics, Chemistry, Biology & English; minimum 45% marks for
                                general and 40% for reserved categories
                            </li>

                            <li className="mt-3">
                                <strong>Fees (Approximate):  </strong><br />
                                • ANM: ₹45,000/year   <br />
                                • GNM: 10+2 in any stream with at least 40% marks<br />
                                • B.Sc Nursing: 10+2 with Physics, Chemistry, Biology & English; minimum 45% marks for
                                general and 40% for reserved categories
                            ...
                            <li className="mt-3">
                                <strong>Why Choose Guru Nanak College?</strong><br />
                                • NAAC Accredited and INC Approved  <br />
                                • Affiliated with Uttarakhand Nurses & Midwives Council<br />
                                • Experienced and qualified faculty with hospital tie-ups <br />
                                • Simulation labs, nursing skill labs, and hands-on training<br />
                                • Safe campus with hostels, canteen, and transport facilities<br />
                                • Focus on ethical education and student mentorship <br />
                                • Active community health outreach and medical camps<br />
                                <p className="mt-5">GNC is a perfect choice for students looking for a high-quality, affordable, and values-driven nursing education in Uttarakhand.</p>
                            </li>
                ...
                <ul className="mb-5" style={{  marginTop: "2rem !important" , listStyleType: "none"}}>
                    <li className="mt-5">
                        ...
                        <p className="mt-5">
                            ...
                            Its School of Nursing is gaining attention for providing career-focused nursing programs with
                        ...
                        <ul className="mt-3" style={{ listStyleType: "upper-roman", }}>
                            ...
                            <li className="mt-3">
                                <strong>Eligibility: </strong><br />
                                • GNM: 10+2 in any stream, preferably science, with 40% marks <br />
                                • B.Sc Nursing: 10+2 with PCB and English; minimum 45% marks (Gen), 40% (Reserved categories)
                            </li>

                            <li className="mt-3">
                                <strong>Fees (Approx): </strong><br />
                                • GNM: ₹60,000/year <br />
                                • B.Sc Nursing: ₹90,000/year
                            ...
                            <li className="mt-3">
                                ...
                                • Affiliated with HNB Garhwal University and approved by INC<br/>
                                • Simulation labs and well-equipped clinical training centers<br/>
                                • Modern campus with Wi-Fi, libraries, digital classrooms, and hostels<br/>
                                • Placement support with links to hospitals across India<br/>
                                • Workshops, seminars, and soft skills training for holistic development
                            </li>
                            <p className="mt-5">With a focus on skill-building, professionalism, and international exposure, BFIT is an ideal choice for
                                students who aspire to build a successful nursing career nationally and internationally. </p>
                        </ul>
                    </li>
                </ul>
                    ...
                    <li>
                        ...
                        <ul className="mt-3" style={{ listStyleType: "upper-roman", }}>
                            ...
                            <li>
                                ...
                                • NABH-accredited hospital, full-time hostel, modern labs
                ...
                <ul className="mt-5" style={{  marginTop: "2rem !important" , listStyleType: "none"}}>
                    <li id="career">
                        ...
                        <ul className="mt-3" style={{ listStyleType: "upper-roman", }}>
                            ...
                            <li>
                                <strong>Campus Perks:</strong><br />
                                • Real-world training, skill development workshops, job placement support
                ...
                <p>Nursing graduates from Dehradun can pursue careers in hospitals, clinics, government health
                    missions, or private organizations. They can also apply for licensure exams for countries like USA
                    (NCLEX-RN), UAE, UK, and Australia. </p>



                <ul>
                    <li><strong>Career Roles: </strong><br />
                        • Staff Nurse<br />
                        • ICU/Pediatric/NICU Nurse <br />
                        • Community Health Nurse<br />
                        • Clinical Instructor or Nurse Educator <br />
                        • Government Nurse through AIIMS, UPPSC, ESIC, etc.<br />
                        • Nursing Abroad with IELTS + Licensure
                ...
                <p className="mb-5">
                    Dehradun is home to several leading nursing colleges that combine clinical training, affordability, and
                    global readiness. Whether you're aiming for government service, private hospitals, or global careers,
                    institutions like Guru Nanak College and BFIT Group of Institutions offer strong platforms for success. <br />
                    If you’re ready to take the next step in your nursing journey, Career Buddy Club is here to support
                    you with free counselling, admission guidance, and application assistance across top nursing colleges
                    in Uttarakhand.</p>
                ...
                <p><strong>Top Nursing Colleges in Dehradun, Best B.Sc Nursing Dehradun, GNM College Dehradun 2025,
                    Nursing Admission Guide Uttarakhand, Guru Nanak College Nursing, BFIT Nursing Dehradun, Nursing
                    Jobs India, ANM GNM BSc Nursing Courses</strong></p>
...
export default NursingDescription;
