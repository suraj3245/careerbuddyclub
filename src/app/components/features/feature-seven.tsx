...
import img_1 from "@/assets/images/assets/img_11.png";
import img_2 from "@/assets/images/assets/img_12.png";
import img_3 from "@/assets/images/assets/img_13.png";
              ...
              <div className="ps-lg-4 wow fadeInRight">
                <div className="title-one">
                  ...
                  <h2 className="text-dark">
                    Find top talents from Career Buddy Club.
                  </h2>
                </div>
                <div
                ...
                >
                  <AccordionItem
                    ...
                    desc="It only takes 5 minutes. Set-up is smooth and simple, with fully customisable page design to reflect your brand. It only takes 5 minutes."
                    parent="accordionOne"
                  />
                  <AccordionItem
                    id="two"
