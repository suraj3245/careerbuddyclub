...
import kvimalogo from "@/assets/images/logo/kvimalogo.webp";
  ...
  return (
    ...
    <Image src={schoolInf.logo} alt="School Logo" width={100} height={100} className="rounded-circle" />
        ...
        <div className="ml-3 w-100">
          <h1 className="h2 text-center" style={{ color: "blue" }}>{schoolInf?.name}</h1>
          <div className="mb-3">
      ...
      <div className="text-left">
        ...
        <div>
          ...
          <p className="mb-0"><strong>Email:</strong> <a href={`mailto:${schoolInf?.contact.email}`}>{schoolInf?.contact.email}</a></p>
        </div>
      </div>
    </div>
  );
