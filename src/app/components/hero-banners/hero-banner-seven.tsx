...
import screen_1 from "@/assets/images/assets/screen17.png";
import screen_2 from "@/assets/images/assets/screen18.png";
              ...
              <div className="col-xxl-7 col-lg-8 col-md-11 m-auto">
                ...
                >
                  ...
                  <ul className="filter-tags d-flex justify-content-center style-none mt-25 lg-mt-20">
                    <li className="fw-500 text-dark me-2">Popular:</li>
                    <li>
                      <a href="#">Design</a>
                    </li>
                    <li>
