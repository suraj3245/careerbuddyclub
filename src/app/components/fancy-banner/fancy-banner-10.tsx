...
const FancyBannerTen = ({ style_2 = false }: { style_2?: boolean }) => {
  const [isVideoOpen, setIsVideoOpen] = useState<boolean>(false);
  return (
    <>
      {!style_2 && (
        <section className="fancy-banner-ten mt-25 lg-mt-25">
      ...
      {style_2 && (
        <section className="fancy-banner-ten mt-150 lg-mt-100">
