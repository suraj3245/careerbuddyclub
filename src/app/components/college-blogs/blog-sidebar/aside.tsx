...
import collegeBlogs from "@/data/college-blog1"; // Correct Import
import { IBlogDataType } from "@/types/blog-type";

const CollegeBlogSidebar = () => {
  ...
  return (
    <aside className="bg-grey p-4 rounded shadow-lg mt-5">
      <h5 className="fw-bold mb-4">
        All Blogs ({collegeBlogs.length})
      </h5>

      <ul className="list-unstyled">
        {collegeBlogs.map((blog: IBlogDataType) => (
          <li key={blog.id} className="mb-3 d-flex gap-3 align-items-start">
            <Image
              src={blog.img}
              alt={blog.title}
              width={109}
      ...
      <div className="card p-4 mt-5 shadow-sm">
        ...
        <ul className="list-unstyled mb-0">
          ...
          <li className="mb-2">
            ...
            <span className="text-primary">{contactDetails.phone}</span>
          </li>
          <li>
            <span>Social:</span>{" "}
            <a
