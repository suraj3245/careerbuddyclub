        ...
        <div className="row align-items-center">
          <div className="col-lg-6 pr-4">
            <h1
              ...
              data-wow-delay="0.3s"
              style={{ color: "#14adbd", paddingLeft: "10px" }}
            >
              Our Mission{" "}
              <span style={{ color: "#eee30d", paddingLeft: "100px" }}>
                {" "}
                Vision &
              </span>
            </h1>
            <h1
              className="wow fadeInUp "
              data-wow-delay="0.3s"
              style={{ color: "#254035", paddingLeft: "200px" }}
            >
              Core Values
            </h1>
          </div>
            ...
            <div className="col">
              <div className="grid-container">
                <div className="mission">
                  ...
                  <p>
                    <strong>Nurturing Futures, Empowering Careers: </strong>
                    Guiding students towards successful career paths and
                    facilitating their transformation from aspirations to
                    accomplishments.
                  </p>
                </div>
                <div className="vision">
                  ...
                  <p>
                    <strong>Shaping Empowered Careers:</strong> To be the
                    foremost catalyst in bridging the gap between education and
                    industry, fostering a realm of limitless possibilities.
                  </p>
                </div>
                <div className="core-values">
                  ...
                  <ul>
                    <li>
                      ...
                      standards in everything we do, enabling students to
                    ...
                    <li>
                      ...
                      approaches to ensure students are prepared for the
